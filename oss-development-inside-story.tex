...
\begin{frame}
  \frametitle{1. cont. Less reviewers}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Rapid fixing is necessary
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{2. cont. - Elastic Recheck}
...
\begin{frame}
  \frametitle{3. cont. English as a second language}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Find a project which you want to join
    \item Find online/offline mentor(s) and friends
    \item Not only code, submit bugs/issues, documentation, etc.
  \end{itemize}
  \centering\includegraphics[height=60mm]{images/tweet-suse.png}
  \centering\includegraphics[height=60mm]{images/tweet-oui.png}
\end{frame}
